"""Rich, informative exception hierarchy for xfinance."""

from __future__ import annotations


class XFinanceError(Exception):
    """Base class for all xfinance exceptions."""


# ── Source errors ─────────────────────────────────────────────────────────────


class SourceError(XFinanceError):
...
class AllSourcesFailedError(XFinanceError):
...
class DataValidationError(XFinanceError):
...
class ConfigurationError(XFinanceError):
    """Invalid library configuration."""


class MissingDependencyError(XFinanceError):
    ...
    def __init__(self, package: str, extra: str) -> None:
        ...
        super().__init__(
            ...
            f"Install it with: pip install xfinance[{extra}]"
        )
